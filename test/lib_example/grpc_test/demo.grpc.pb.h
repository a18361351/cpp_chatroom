 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::hello::HelloResp>> PrepareAsyncSayHello(::grpc::ClientContext* context, const ::hello::HelloReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::hello::HelloResp>>(PrepareAsyncSayHelloRaw(context, request, cq));
    }
    class async_interface {
     public:
      virtual ~async_interface() {}
      virtual void SayHello(::grpc::ClientContext* context, const ::hello::HelloReq* request, ::hello::HelloResp* response, std::function<void(::grpc::Status)>) = 0;
      virtual void SayHello(::grpc::ClientContext* context, const ::hello::HelloReq* request, ::hello::HelloResp* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::hello::HelloResp>* PrepareAsyncSayHelloRaw(::grpc::ClientContext* context, const ::hello::HelloReq& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::hello::HelloResp>> PrepareAsyncSayHello(::grpc::ClientContext* context, const ::hello::HelloReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::hello::HelloResp>>(PrepareAsyncSayHelloRaw(context, request, cq));
    }
    class async final :
      public StubInterface::async_interface {
     public:
      void SayHello(::grpc::ClientContext* context, const ::hello::HelloReq* request, ::hello::HelloResp* response, std::function<void(::grpc::Status)>) override;
      void SayHello(::grpc::ClientContext* context, const ::hello::HelloReq* request, ::hello::HelloResp* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::hello::HelloResp>* PrepareAsyncSayHelloRaw(::grpc::ClientContext* context, const ::hello::HelloReq& request, ::grpc::CompletionQueue* cq) override;
   ...
   public:
    WithCallbackMethod_SayHello() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::hello::HelloReq, ::hello::HelloResp>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::hello::HelloReq* request, ::hello::HelloResp* response) { return this->SayHello(context, request, response); }));}
    void SetMessageAllocatorFor_SayHello(
        ::grpc::MessageAllocator< ::hello::HelloReq, ::hello::HelloResp>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::hello::HelloReq, ::hello::HelloResp>*>(handler)
    ...
    virtual ::grpc::ServerUnaryReactor* SayHello(
      ::grpc::CallbackServerContext* /*context*/, const ::hello::HelloReq* /*request*/, ::hello::HelloResp* /*response*/)  { return nullptr; }
  };
    ...
    WithStreamedUnaryMethod_SayHello() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::hello::HelloReq, ::hello::HelloResp>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::hello::HelloReq, ::hello::HelloResp>* streamer) {
