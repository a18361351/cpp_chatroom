...
namespace chatroom {
    ...
    TaskIter TimerTaskManager::CreateTimer(std::chrono::milliseconds duration, std::function<void()> callback, bool auto_reset) {
    ...
    boost::asio::io_context& TimerTaskManager::GetContext() {
        return ctx_;
    }
