...
namespace chatroom::backend {
    ...
    void Session::QueueSend()  {
        ...
        boost::asio::async_write(sock_, buffer(sending_->data_ + sending_->cur_pos_, sending_->ctx_len_ + HEAD_LEN - sending_->cur_pos_), 
    ...
    void Session::ReceiveHead() {
        ...
        boost::asio::async_read(sock_, boost::asio::buffer(recv_ptr_->data_ + recv_ptr_->cur_pos_, HEAD_LEN - recv_ptr_->cur_pos_), 
                                boost::asio::bind_executor(strand_, cb));
    }
    void Session::ReceiveContent() {
        ...
        //                     boost::asio::bind_executor(strand_, cb));
        boost::asio::async_read(sock_, boost::asio::buffer(recv_ptr_->data_ + recv_ptr_->cur_pos_, recv_ptr_->ctx_len_ + HEAD_LEN - recv_ptr_->cur_pos_), 
                                boost::asio::bind_executor(strand_, cb));
    }
