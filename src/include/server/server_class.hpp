...
class ServerClass {
   public:
    ...
    ServerClass(uint32_t server_id, string server_addr, boost::asio::io_context &listener_ctx,
                const std::string &status_rpc_addr, const sw::redis::ConnectionOptions &redis_conn_opts,
